...
class _HomePageScreenState extends State<HomePageScreen> {
  ...
  Future<void> _loadHomes() async {
    ...
    try {
      final List<Home> homes = (await ApiServices().getHomes()) as List<Home>;
      setState(() {
        _homes = homes;
        isLoading = false;
        errorMessage = '';
      ...
      setState(() {
        isLoading = false;
        errorMessage =
            'une erreur s\est produite lors de la recuperation des maison';
      });
    }
  }
            ...
            children: <Widget>[
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  // Placez un point d'arrêt ici pour inspecter les données à chaque création d'élément
                  return Padding(
                    padding: const EdgeInsets.only(top: 10),
                    child: ImageWidget(home),
                  );
                },
              ),
            ],
